...
if __name__ == '__main__':
    ...
    if ns == "hipster":
        normal_time1 = "2025-06-06 03:51"
        path1 = dirname(__file__) +  "/rca_data/2025-06-06/2025-06-06-fault_list.json"

        normal_time2 = "2025-06-07 17:00"
        path2 = dirname(__file__) +  "/rca_data/2025-06-07/2025-06-07-fault_list.json"
